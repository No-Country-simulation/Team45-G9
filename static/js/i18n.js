...
(function () {
  ...
  var DICT = {
    ...
    eq_vampire:      { es: 'Cargadores que dejas enchufados sin usar (celular, tablet, notebook)', en: 'Chargers you leave plugged in unused (phone, tablet, laptop)', pt: 'Carregadores que você deixa ligados sem uso (celular, tablet, notebook)' },
    eq_vampire_hint: { es: 'Aunque no estén cargando nada, siguen consumiendo un poco de electricidad — es el "consumo fantasma".', en: "Even when not charging anything, they still draw a little electricity — that's \"phantom load\".", pt: 'Mesmo sem carregar nada, eles continuam consumindo um pouco de eletricidade — é o "consumo fantasma".' },
    ...
    label_laundry:  { es: '¿Cuántos lavados semanales realizas?', en: 'How many weekly washes do you do?', pt: 'Quantas lavagens semanais você faz?' },
    label_fridge:   { es: '¿Cuántos refrigeradores / heladeras tienes?', en: 'How many refrigerators do you have?', pt: 'Quantas geladeiras você tem?' },
    label_freezer:  { es: '¿Cuántos freezers independientes tienes?', en: 'How many standalone freezers do you have?', pt: 'Quantos freezers independentes você tem?' },
    ...
    label_tv:       { es: '¿Cuántos televisores tienes?', en: 'How many televisions do you have?', pt: 'Quantas televisões você tem?' },
    ...
    q_horario_pico:  { es: '¿En qué momentos del día usas más electricidad? Puedes marcar varios. Si tienes tu boleta de luz a mano, puedes subirla en la pantalla para que se lea el consumo automáticamente; esa opción no está disponible por voz.', en: 'When during the day do you use the most electricity? You can select several. If you have your electricity bill handy, you can upload it on screen so the consumption is read automatically; that option is not available by voice.', pt: 'Em que momentos do dia você usa mais eletricidade? Você pode marcar vários. Se você tiver sua conta de luz à mão, pode enviá-la na tela para que o consumo seja lido automaticamente; essa opção não está disponível por voz.' },
    ...
    denji_calculando:       { es: 'Listo, ya tengo todo. Voy a calcular tu consumo, dame un segundo.', en: "Great, I have everything. I'll calculate your consumption, give me a second.", pt: 'Pronto, já tenho tudo. Vou calcular seu consumo, me dê um segundo.' },
    denji_resumen_fallback: { es: 'Te hago el resumen.', en: "Here's your summary.", pt: 'Aqui está o resumo.' },
    denji_tardando:         { es: 'El cálculo está tardando más de lo normal. Revisa la pantalla, puede que haya un error.', en: 'The calculation is taking longer than usual. Check the screen, there might be an error.', pt: 'O cálculo está demorando mais que o normal. Verifique a tela, pode haver um erro.' },
    denji_resultado_listo:  { es: 'Listo, aquí está tu resultado.', en: "Done, here's your result.", pt: 'Pronto, aqui está o seu resultado.' },
    denji_consumo_estimado: { es: 'Tu consumo estimado es {valor}.', en: 'Your estimated consumption is {valor}.', pt: 'Seu consumo estimado é {valor}.' },
    denji_ahorro_potencial: { es: 'Tu ahorro potencial es {valor}.', en: 'Your potential savings is {valor}.', pt: 'Sua economia potencial é {valor}.' },
    denji_mis_recomendaciones: { es: 'Mis recomendaciones: {valor}', en: 'My recommendations: {valor}', pt: 'Minhas recomendações: {valor}' },
    denji_detectando_ubicacion: { es: 'Detectando tu ubicación…', en: 'Detecting your location…', pt: 'Detectando sua localização…' },
    denji_permiso_ubicacion: { es: 'Tu navegador te va a pedir permiso para usar tu ubicación. Consultamos la ciudad en OpenStreetMap enviando solo una posición aproximada.', en: 'Your browser will ask permission to use your location. We look up the city on OpenStreetMap, sending only an approximate position.', pt: 'Seu navegador vai pedir permissão para usar sua localização. Consultamos a cidade no OpenStreetMap enviando apenas uma posição aproximada.' },
