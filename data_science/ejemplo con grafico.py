...
def plot_kwh_comparison(kwh, kwh_predicted, filename="kwh_comparison.png"):
    values = [kwh, kwh_predicted]
    labels = ["Actual KWH", "Predicted KWH"]

    plt.figure(figsize=(5, 5))
    bars = plt.bar(labels, values)

    plt.ylabel("Annual KWH")
...
plot_kwh_comparison(
    kwh=result['KWH observados'],
    kwh_predicted=result['KWH estimados'],
